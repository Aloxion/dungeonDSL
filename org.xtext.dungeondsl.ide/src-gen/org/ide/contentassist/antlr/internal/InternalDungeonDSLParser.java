...
public class InternalDungeonDSLParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'true'", "'false'", "'LARGE'", "'MEDIUM'", "'SMALL'", "'COMBAT'", "'TREASURE'", "'BOSS'", "'PUZZLE'", "'SHOP'", "'stepOn'", "'openDoor'", "'Dungeon'", "'{'", "'theme'", "'='", "'lvl'", "'}'", "'Floor'", "'Room'", "'size'", "'type'", "'floorID'", "'connections'", "'['", "']'", "','", "'Trap'", "'trigger'", "'disarmable'", "'triggerChance'"
    };
    ...
    // InternalDungeonDSL.g:1011:1: rule__Room__Group__9__Impl : ( 'floorID' ) ;
    public final void rule__Room__Group__9__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalDungeonDSL.g:1015:1: ( ( 'floorID' ) )
            // InternalDungeonDSL.g:1016:1: ( 'floorID' )
            {
            // InternalDungeonDSL.g:1016:1: ( 'floorID' )
            // InternalDungeonDSL.g:1017:2: 'floorID'
            {
